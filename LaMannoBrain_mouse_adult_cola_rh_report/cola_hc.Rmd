...
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 326))', 'n_signatures \u2265 326', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 459))', 'n_signatures \u2265 459', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1015))', 'n_signatures \u2265 1015', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 2287))', 'n_signatures \u2265 2287', prefix = 'collect-classes-from-hierarchical-partition')
knitr_add_tab_item('collect_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 6256))', 'n_signatures \u2265 6256', prefix = 'collect-classes-from-hierarchical-partition')
...
```{r, results = "asis", echo = FALSE, include = TRUE}
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 326))', 'n_signatures \u2265 326', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 459))', 'n_signatures \u2265 459', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 1015))', 'n_signatures \u2265 1015', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 2287))', 'n_signatures \u2265 2287', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
knitr_add_tab_item('get_classes(res_rh, merge_node = merge_node_param(min_n_signatures = 6256))', 'n_signatures \u2265 6256', prefix = 'get-classes-from-hierarchical-partition', hide_and_show = TRUE)
...
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 326),
    method = "UMAP", top_value_method = "ATC", top_n = 1000, scale_rows = TRUE)', 'n_signatures \u2265 326', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 459),
    method = "UMAP", top_value_method = "SD", top_n = 1000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 459),
    method = "UMAP", top_value_method = "ATC", top_n = 1000, scale_rows = TRUE)', 'n_signatures \u2265 459', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1015),
    method = "UMAP", top_value_method = "SD", top_n = 1000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 1015),
    method = "UMAP", top_value_method = "ATC", top_n = 1000, scale_rows = TRUE)', 'n_signatures \u2265 1015', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 2287),
    method = "UMAP", top_value_method = "SD", top_n = 1000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 2287),
    method = "UMAP", top_value_method = "ATC", top_n = 1000, scale_rows = TRUE)', 'n_signatures \u2265 2287', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
knitr_add_tab_item('par(mfrow = c(1, 2))
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 6256),
    method = "UMAP", top_value_method = "SD", top_n = 1000, scale_rows = FALSE)
dimension_reduction(res_rh, merge_node = merge_node_param(min_n_signatures = 6256),
    method = "UMAP", top_value_method = "ATC", top_n = 1000, scale_rows = TRUE)', 'n_signatures \u2265 6256', prefix = 'dimension-reduction-by-depth', opt = "fig.width = 14, fig.height = 7, out.width = '100%'")
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 326))', 'n_signatures \u2265 326', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 459))', 'n_signatures \u2265 459', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 1015))', 'n_signatures \u2265 1015', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 2287))', 'n_signatures \u2265 2287', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
knitr_add_tab_item('get_signatures(res_rh, merge_node = merge_node_param(min_n_signatures = 6256))', 'n_signatures \u2265 6256', opt = 'results="hide"', prefix = 'get-signatures-from-hierarchical-partition')
...
```{r, results = 'asis', echo = FALSE, include = TRUE}
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 326))', 'n_signatures \u2265 326', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 459))', 'n_signatures \u2265 459', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 1015))', 'n_signatures \u2265 1015', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 2287))', 'n_signatures \u2265 2287', prefix = 'test-to-known-factors-from-hierarchical-partition')
knitr_add_tab_item('test_to_known_factors(res_rh, merge_node = merge_node_param(min_n_signatures = 6256))', 'n_signatures \u2265 6256', prefix = 'test-to-known-factors-from-hierarchical-partition')
