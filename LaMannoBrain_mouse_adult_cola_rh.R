setwd("/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_mouse_adult")
library(cola)
...
library(scRNAseq)
data = readRDS('/omics/groups/OE0246/internal/guz/cola_hc/examples/LaMannoBrain_mouse_adult/LaMannoBrain_mouse_adult_data.rds')
